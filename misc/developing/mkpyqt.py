...
# From: Rapid GUI programming with Python and Qt : the definitive guide to PyQt programming / Mark Summerfield.

# This script can be used to convert .ui files to .py files, saving the time of typing
# the same sets of commands every time you update the GUI design.
