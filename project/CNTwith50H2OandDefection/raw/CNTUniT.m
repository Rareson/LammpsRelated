...
fractureStress = zeros(2,length(d));
fractureStrain = zeros(2,length(d));
...
figure
plot(300:300:900, fractureStrain(1,1:3),'-o')
hold on
plot(300:300:900, fractureStrain(2,1:3),'-.')
legend('Tensile')
set(gca,'LineWidth',2,'FontSize',24,'FontWeight','normal','FontName','Times')
...
figure
plot(300:300:900, fractureStress(1,1:3),'-o')
hold on
plot(300:300:900, fractureStress(2,1:3),'-.')
legend('Tensile')
set(gca,'LineWidth',2,'FontSize',24,'FontWeight','normal','FontName','Times')
set(get(gca,'xlabel'),'String','Temperature (K)','FontSize',32,'FontWeight','bold','FontName','Times')
